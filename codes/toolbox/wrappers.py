...
def get_network(network_file, only_lcc, use_edge_data = True):
    network = network_utilities.create_network_from_sif_file(network_file, use_edge_data = use_edge_data, delim = None, include_unconnected=True)
...
def calculate_proximity(network, nodes_from, nodes_to, drug_name=None, nodes_from_random=None, nodes_to_random=None, bins=None, n_random=1000, min_bin_size=100, seed=452456, lengths=None,
    ...
    d = calculate_closest_distance(network, nodes_from, nodes_to, lengths, logger=logger)
